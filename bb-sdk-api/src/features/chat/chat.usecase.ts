...
import { WsEvent } from '../../events/ws_event';
...
export class ChatUseCases {
  ...
  async updateMessage({
    ...
    try {
      ...
      // Emit chat update event via Socket
      this.eventsGateway.emit(
        existsMessage.meeting.id.toString(),
        WsEvent.chatUpdate,
        updatedMessage,
      );
  ...
  async deleteMessage({
    ...
    try {
      ...
      // Emit chat delete event via Socket
      this.eventsGateway.emit(
        existsMessage.meeting.id.toString(),
        WsEvent.chatDelete,
        updatedMessage,
